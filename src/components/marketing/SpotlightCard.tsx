...
export function SpotlightCard({ children, className = '' }: { children: React.ReactNode; className?: string }) {
  ...
  return (
    <div
      ...
      className={`relative rounded-3xl border border-border/50 bg-card backdrop-blur-xl shadow-lg transition-transform duration-300 hover:scale-[1.02] ${className}`}
    >
      <div
